...
class _ViewPhotosState extends State<ViewPhotos> {
  static String base_url = "http://sutlejclub.in/aadmin/public/";
          ...
          PhotoViewGallery.builder(
            ...
            builder: (BuildContext context, int index) {
              return PhotoViewGalleryPageOptions(
                imageProvider: widget.imageList[index].photo!
                        .contains("http://")
                    ? CachedNetworkImageProvider(widget.imageList[index].photo!)
                    : CachedNetworkImageProvider(
                        base_url + widget.imageList[index].photo!),
                heroAttributes:
